...
export default function AnimalesScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      ...
      {/* Modal exclusivo para CREAR un animal */}
      <Modal
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: "bold", color: "#154212" },
  headerActions: { flexDirection: "row", gap: 8 },
  btnScan: { width: 44, height: 44, borderRadius: 22, backgroundColor: "#ffffff", borderWidth: 1, borderColor: "#c2c9bb", justifyContent: "center", alignItems: "center" },
  btnRegister: { flexDirection: "row", alignItems: "center", backgroundColor: "#154212", paddingHorizontal: 16, height: 44, borderRadius: 22, gap: 4 },
  btnRegisterText: { color: "#ffffff", fontSize: 12, fontWeight: "bold", letterSpacing: 0.5 },
  searchContainer: { flexDirection: "row", alignItems: "center", backgroundColor: "#ffffff", marginHorizontal: 20, marginBottom: 16, paddingHorizontal: 12, height: 48, borderRadius: 12, borderWidth: 1, borderColor: "#e3e3de" },
  searchIcon: { marginRight: 8 },
  searchInput: { flex: 1, fontSize: 14, color: "#1a1c19" },
  listContent: { paddingHorizontal: 20, paddingBottom: 20 },
  card: { flexDirection: "row", backgroundColor: "#ffffff", borderRadius: 16, padding: 12, marginBottom: 12, borderLeftWidth: 6, shadowColor: "#2d5a27", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 12, elevation: 3 },
  imageContainer: { width: 80, height: 80, borderRadius: 12, backgroundColor: "#f4f4ee", justifyContent: "center", alignItems: "center", overflow: "hidden", marginRight: 12 },
  image: { width: "100%", height: "100%" },
  infoContainer: { flex: 1, justifyContent: "center" },
  cardHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 4 },
  codeBadge: { fontSize: 11, fontFamily: Platform.OS === "ios" ? "Menlo" : "monospace", color: "#5b5f5c", backgroundColor: "#f4f4ee", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, letterSpacing: 0.5 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 12 },
  statusText: { fontSize: 10, fontWeight: "bold", letterSpacing: 0.5 },
  animalName: { fontSize: 18, fontWeight: "bold", color: "#1a1c19", marginBottom: 2 },
  animalBreed: { fontSize: 14, color: "#5b5f5c", marginBottom: 8 },
  weightRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  weightText: { fontSize: 12, color: "#72796e" },
  emptyContainer: { alignItems: "center", marginTop: 60 },
  emptyText: { marginTop: 12, fontSize: 16, color: "#5b5f5c" },
});